...
%>
<!-- 확인용 :attr_locationion %>attr_ageage %>attr_heihei %>/min_heightght %> / <%= max_height%>
-->
<%
	String text = "SELECT * FROM ATTRACTION";
	if (attr_location != 2222) {//위치 상관없음
		text += " WHERE attr_location = " + attr_location + " AND " + min_age
				+ " <= attr_min_age AND attr_max_age <= " + max_age;
